...
const featureCards = [
  {
    icon: CalendarDays,
    title: 'Plan the full week clearly',
    text: 'Organise breakfast, lunch and dinner in one place so the whole household can see what is coming up.',
  },
  {
    icon: Users,
    title: 'Built around household needs',
    text: 'Keep diets, allergies, cuisines and preferences together so planning feels practical for everyone.',
  },
  {
    icon: ShoppingCart,
    title: 'Shopping gets easier',
    text: 'Turn the weekly plan into a more useful shopping list and keep your progress saved between visits.',
  },
];

const previewPanels = [
  {
    title: 'A weekly planner that feels manageable',
    text: 'See the whole week at a glance and make swaps quickly without losing track of the bigger plan.',
    image:
      'https://images.unsplash.com/photo-1498837167922-ddd27525d352?auto=format&fit=crop&w=1200&q=80',
  },
  {
    title: 'Balanced and practical meal ideas',
    text: 'Use the app to support a balanced and nutritious diet across the week without making meal planning feel heavy or complicated.',
    image:
      'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=1200&q=80',
  },
  {
    title: 'Recipes and shopping in one flow',
    text: 'Save favourites, manage your own recipes and keep the shopping side connected to what is actually planned.',
    image:
      ...
      <main className="container" style={{ paddingTop: 28, paddingBottom: 48 }}>
        ...
        >
          <div style={{ padding: 'clamp(24px, 5vw, 44px)', maxWidth: 760 }}>
            ...
            >
              <Sparkles size={14} /> Sign in to MealMagic
            </div>
        ...
        <section className="section grid grid-2" style={{ alignItems: 'stretch' }}>
          <div className="card" style={{ padding: 26 }}>
            ...
            <p className="small" style={{ fontSize: 16, lineHeight: 1.8 }}>
              Signing in lets MealMagic remember your household, your saved recipes, your planner and your shopping progress, so the experience feels personal and useful every time you come back.
            </p>
